...
namespace FlagsApp.Migrations
{
    ...
    [Migration("20240213235522_AddFlagGraphicElement")]
    partial class AddFlagGraphicElement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlagsApp.Models.FlagGraphicElement", b =>
                {
                    b.Property<int>("FlagId")
                        .HasColumnType("int");

                    b.Property<int>("GraphicElementId")
                        .HasColumnType("int");

                    b.HasKey("FlagId", "GraphicElementId");

                    b.HasIndex("GraphicElementId");

                    b.ToTable("FlagGraphicElements");
                });
            ...
            modelBuilder.Entity("FlagsApp.Models.GraphicElement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlagsApp.Models.FlagGraphicElement", b =>
                {
                    ...
                    b.HasOne("FlagsApp.Models.GraphicElement", null)
                        .WithMany()
